...
main:
  ...
  syscall           			# print the string
 				...
 				# Calculate perimeter
  add	$8, $8, $8			# Double the width
  add   $8, $9, $8			# 2* width + height
  add	$8, $9, $8			# 2*width + 2*height
  ...
  syscall           			# print the string
  				...
  				# Print the calculated area (in $8)
  addi 	$v0, $0, 1  			# system call 1 is for printing an integer
  add 	$a0, $0, $8 			# bring the area value from $10 into $a0
  syscall           			# print the integer
